...
@NgModule({
  declarations: [TerminalsComponent, ListTerminalsComponent, CreateTerminalComponent, EditTerminalComponent],
  providers:[TerminalsService],
  imports     : [CommonModule,TerminalsRoutes,SharedModule],
  exports     : [TerminalsComponent, ListTerminalsComponent, CreateTerminalComponent, EditTerminalComponent],
})
